...
$header .= "From: Новая заявка <maria.filenchik@yandex.by>\n\n";	
$mail = mail("maria.filenchik@yandex.by", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
